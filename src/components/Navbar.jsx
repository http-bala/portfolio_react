...
const Navbar = () => {
  ...
  return (
    <nav className='md:max-w-screen-xl m-auto p-4 md:p-0 z-100  md:flex md:items-center md:justify-between cursor-pointer'>
      ...
      <ul className={`md:flex md:items-center z-[1] md:z-auto md:static absolute w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 bg-gradient-to-b from-slate-900 to-purple-900 md:bg-none ${Nav ? "top-[-400px]" : "top-[70px] "}   transition-all ease-in duration-500`}>
